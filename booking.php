...
$result = mysqli_query($conn, "select noPolisi, tglBeli, detail_servis.noRangka, tglServisTerakhir, tglServisSelanjutnya from pelanggan, mobil, detail_servis where pelanggan.id = $id and mobil.noRangka = '$noRangka' and mobil.noRangka = detail_servis.noRangka ORDER BY tglServisSelanjutnya ASC");
?>
<!DOCTYPE html>
<html>
        ...
        <div class="container">
                ...
                <h5>Data Booking </h5>  
                    <form action="" id="fupForm" name="form1" method="post">
                        ...
                        <input class="form-control form-insert" type="text" id="teleponbooking" name="teleponbooking" placeholder="Telepon (Contoh: +6281381669200)">

                        <label for="tglBeli">Tanggal Booking:</label><br>
                        <input class="form-control form-insert" type="date" id="tanggalbooking" name="tanggalbooking">   
    ...
    <script>
        $(document).ready(function() {
            function capitalizeFirstLetters(str) {
                ...
                $("#teleponbooking").autoNumeric('init', {
                    aSep: '',
                    aDec: '.',
                    aForm: true,
                    aSign: ' +62',
                ...
                $('#servis').on('click', function() {
                    ...
                    var teleponbooking = $('#teleponbooking').val();
                    var tanggalbooking = $('#tanggalbooking').val();    
                    var jambooking = $('#jambooking').val();
                    var noRangka = $('#noRangka').val();


                    if (namabooking != "" && teleponbooking != "" && tanggalbooking != "" && jambooking != "" && noRangka != "") {
