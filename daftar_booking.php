...
$result = mysqli_query(
    $conn, "select namaBooking, noTelponBooking, tglBooking, jamBooking, noRangka from booking ORDER BY tglBooking ASC");
                ...
                <table class="table is-bordered" id="tabel-data">
                    ...
                    <tbody>
                        ...
                        foreach ($arr as $user_data) {
                            ...
                            echo "<td>" . $user_data['noTelponBooking'] . "</td>";
                            echo "<td>" . $user_data['tglBooking'] . "</td>";
